...
impl LegacyRawLauncher {
    ...
    pub fn migrate_type(&self) -> LauncherVariant {
        match self.r#type.as_str() {
            ...
            "calculation" => LauncherVariant::Calculator,
            "categories" => LauncherVariant::Category,
            "clipboard-execution" => LauncherVariant::Clipboard,
            "command" => LauncherVariant::Command,
            "debug" => LauncherVariant::Debug,
            "emoji_picker" => LauncherVariant::Emoji,
            "files" => LauncherVariant::Files,
            "teams_event" => LauncherVariant::Event,
            "theme_picker" => LauncherVariant::Theme,
